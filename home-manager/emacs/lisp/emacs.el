...
(defun my-eglot-organize-imports () (interactive "p")
...
(defun add-browser-bookmark ()
  ...
  (interactive)
  (let* (
         (bookmark-file-path "~/Ontwikkeling/Persoonlijk/dotfiles/nix/nixos/users/joe/nyxt/lisp/bookmarks.lisp")
...
(defun nixos-rebuild ()
  ...
  (let ((default-directory "~/Ontwikkeling/Persoonlijk/dotfiles"))
    (async-shell-command "make nixos-rebuild")
    ))
...
(defun nixos-emacs-config-file-joe ()
  ...
  (interactive)
  (find-file "~/Ontwikkeling/Persoonlijk/dotfiles/nix/nixos/users/joe/emacs/packages.nix")
  )
